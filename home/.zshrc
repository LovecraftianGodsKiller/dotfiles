...
# Changing 'ls' to 'lsd'
alias l='exa -alFh --color=always --icons --group-directories-first' # my preferred listing
alias ls='exa -alFh --color=always --icons --group-directories-first' # my preferred listing
alias lt='exa -alFhT --color=always --icons --group-directories-first' # my preferred tree listing
alias lst='exa -alFhT --color=always --icons --group-directories-first' # my preferred tree listing
